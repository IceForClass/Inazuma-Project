...
UPDATE jugadores
SET PATADA = nuevo_valor_de_PATADA,
    TÉCNICA = nuevo_valor_de_TÉCNICA,
    CONTROL = nuevo_valor_de_CONTROL,
    INTELIGENCIA = nuevo_valor_de_INTELIGENCIA,
    PRESIÓN = nuevo_valor_de_PRESIÓN,
    AGILIDAD = nuevo_valor_de_AGILIDAD,
    FÍSICO = nuevo_valor_de_FÍSICO,
    TOTAL = nuevo_valor_de_TOTAL,
    Descripcion = 'Nueva descripción'
WHERE Nombre = 'Clear' AND Equipo = 'Polvo De Diamantes' AND Posición = 'Defensa' AND Afinidad = 'Aire';
